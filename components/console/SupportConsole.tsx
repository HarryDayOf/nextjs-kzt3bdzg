    ...
    <div style={{ fontFamily: "'Inter',-apple-system,sans-serif", backgroundColor: '#f4f5f7', minHeight: '100vh' }}>
      ...
      <header style={{ backgroundColor: NAVY, borderBottom: '1px solid rgba(255,255,255,0.08)', padding: '0 28px', height: '56px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 50 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <button onClick={() => { sessionStorage.removeItem('dayof_user'); window.location.href = '/'; }} style={{ padding: '5px 10px', backgroundColor: 'transparent', border: '1px solid rgba(255,255,255,0.2)', borderRadius: '8px', fontSize: '11px', color: 'rgba(255,255,255,0.6)', cursor: 'pointer' }}>Sign out</button>
        </div>
      </header>
